...
const controls = {
  ...
  'Cloud Color 1': [255,245,233],
  'Cloud Color 2': [247,240,221],
  'Clouds': 0.36,
  'Civilization': 0.6,
  'Landmass': 0.29,
...
function main() {
  ...
  gui.addColor(controls, 'Cloud Color 1');
  gui.addColor(controls, 'Cloud Color 2');
  ...
  function tick() {
    ...
    fog.setGeometryColor(colArrayToVec4(controls["Cloud Color 1"]));
    fog.setSecondaryColor(colArrayToVec4(controls["Cloud Color 2"]));
    ...
    planet.setGeometryColor(colArrayToVec4(controls["Cloud Color 1"]));
    planet.setSecondaryColor(colArrayToVec4(controls["Cloud Color 2"]));
