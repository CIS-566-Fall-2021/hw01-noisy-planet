...
class ShaderProgram {
  ...
  unifColor5:WebGLUniformLocation;
  ...
  constructor(shaders: Array<Shader>) {
    ...
    this.unifColor5     = gl.getUniformLocation(this.prog, "u_Color5");
  ...
  setColor5(color: vec4) { 
    this.use();
    if(this.unifColor5 !== -1) {
      gl.uniform4fv(this.unifColor5, color);
    }
  }
  ...
  setAnimationSpeed(s: number) {
    this.use();
    gl.uniform1f(this.unifSpeed, s);
  }

  setGlobalWarmingSpeed(s: number) {
    this.use();
    gl.uniform1f(this.unifWarming, s);
  }
